                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                    ...
                    <div className='lg:flex items-center justify-between bg-white rounded-lg flex-shrink-0 flex-grow p-8 space-y-4'>
                        <div className='lg:w-1/2'>
                            ...
                            <h4 className='text-lg md:text-3xl xl:text-4xl lg:font-medium'><span className='text-gray-400 text-lg'>$</span>
                        ...
                        <div className='lg:w-1/2 space-y-4'>
                            <div>
                                ...
                                <h4 className='text-lg md:text-3xl xl:text-4xl lg:font-medium'>
